...
parser.add_argument('--scl_lr', type=float, help='scl learning rate', default=0.01)
...
parser.add_argument('--alpha', type=float, help='the control in scl', default=0.1)
parser.add_argument('--deg', type=float, help='degree of student distribution', default=1)
parser.add_argument('--k', type=int, help='top-k self-training sample', default=50)
parser.add_argument('--beta', type=float, help='the control in self training', default=0.1)
